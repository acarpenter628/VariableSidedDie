...
bool Adafruit_MMA8451::begin(uint8_t i2caddr) {
  ...
  // Tap on INT2
  writeRegister8(MMA8451_REG_CTRL_REG4, ACCEL_INT_SOURCE_TAP);
  //writeRegister8(MMA8451_REG_CTRL_REG5, 0x01);
  writeRegister8(MMA8451_REG_TAP_CFG, TAP_CONFIG_SINGLE_ALL_AXIS);
  writeRegister8(MMA8451_REG_TAP_THRESH_X, TAP_CONFIG_THRESH);
  writeRegister8(MMA8451_REG_TAP_THRESH_Y, TAP_CONFIG_THRESH);
  writeRegister8(MMA8451_REG_TAP_THRESH_Z, TAP_CONFIG_THRESH);
...
*/
/**************************************************************************/
uint8_t Adafruit_MMA8451::getIntSource(void) 
{
  return readRegister8(MMA8451_REG_OUT_INT_STATUS);
}
